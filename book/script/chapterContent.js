$(function () {
    ...
    $.ajax({
        url: 'http://112.74.48.36:8080/novel/chapterContent.action?',
        type: 'get',
        dataType: 'json',
        ...
        success: function (data) {
            ...
            var prevKeys = {
                chapterUrl1: getChapterKeys(data.keys, "prev1"),
                chapterUrl2: getChapterKeys(data.keys, "prev2")
            };
            var nextKeys = {
                chapterUrl1: getChapterKeys(data.keys, "next1"),
            ...
            $("#nav_left_end").html("<a href='chapterContent.html?encr=" + data.chapterDetail.prev + "&keys=" + JSON.stringify(prevKeys) + "'>上一章</a>");
            $("#nav_right_end").html("<a href='chapterContent.html?encr=" + data.chapterDetail.next + "&keys=" + JSON.stringify(nextKeys) + "'>下一章</a>");
